...
# Show figure of FDis Canopy height ~ EUNIS
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2024-09-05
...
p1 <- ggplot(sites, aes(y = fdis.abu.height, x = esy16, fill = esy16)) +
  geom_quasirandom(color = "grey") +
  geom_boxplot(alpha = .5) +
  scale_fill_viridis_d(guide = "none") +
  scale_y_continuous(limits = c(1,3.7)) +
  labs(y = "FDis Height (abu)", title = "Canopy height", tag = "B") +
  theme_mb() +
...
ggsave(
  here("outputs", "figures", "figure_fdis_eunis_1_height_300dpi_10x10cm.tiff"),
