...
# Show figure of FDis SLA ~ EUNIS x site.type
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2024-09-05
...
medians <- sites %>%
  ...
  summarise(median = median(fdis.abu.sla)) %>%
...
ggsave(
  here(
    "outputs", "figures",
    "figure_cwm_eunis_2_site.type_sla_300dpi_17x8cm.tiff"
  ),
