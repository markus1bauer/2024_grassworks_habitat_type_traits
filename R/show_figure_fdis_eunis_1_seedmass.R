...
# Show figure of FDis Seed mass ~ EUNIS
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2024-09-05
...
p1 <- ggplot(sites, aes(y = fdis.abu.seedmass, x = esy16, fill = esy16)) +
  geom_quasirandom(color = "grey") +
  geom_boxplot(alpha = .5) +
  scale_fill_viridis_d(guide = "none") +
  scale_y_continuous(limits = c(1,3.7)) +
  labs(y = "FDis Seed mass (abu)", title = "Seed mass", tag = "C") +
  theme_mb() +
...
ggsave(
  here(
    "outputs", "figures", "figure_fdis_eunis_1_seedmass_300dpi_10x10cm.tiff"
  ),
