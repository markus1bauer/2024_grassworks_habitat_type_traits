...
# Show figure of Canopy height ~ EUNIS x site.type
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2024-05-09
...
medians <- sites %>%
  ...
  summarise(median = median(cwm.abu.height)) %>%
...
ggsave(
  here(
    "outputs", "figures",
    "figure_cwm_eunis_2_site.type_height_300dpi_17x10cm.tiff"
  ),
