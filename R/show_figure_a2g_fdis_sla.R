...
# Show figure A2 functional dispersion SLA
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2026-06-04
...
graph <- ggplot() +
  ...
  scale_y_continuous(limits = c(1, 3.5), breaks = seq(0, 10, .5)) +
  labs(
    x = "",
    y = expression("FDis SLA"),
    tag = "G"
  ) +
  theme_mb(); graph
...
ggsave(
  here("outputs", "figures", "figure_a2g_fdis_sla_300dpi_9x6cm.tiff"),
