...
# Show figure of FDis Canopy height ~ EUNIS x site.type
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Markus Bauer
# 2024-09-05
...
medians <- sites %>%
  ...
  summarise(median = median(fdis.abu.height)) %>%
...
ggsave(
  here(
    "outputs", "figures",
    "figure_fdis_eunis_2_site.type_height_300dpi_17x8cm.tiff"
  ),
